...
#设定初始值
date='2022-12-01~2023-12-31'#这里可以根据自己所要的时间跨度自行修改
start=5421#自己设定从firm_message.csv的第几行开始
end=5520#自己设定从firm_message.csv的第几行结束,建议每200/300家公司爬取一次
...
def getinfor():
    ...
    ws = wb.active
    with open('2022ndbg_data.csv', mode='a', encoding='utf-8', newline='') as f:
                ...
                for page in range(1, total_pages + 1):
                    ...
                    post_data = {
                        ...
                        'trade': '农、林、牧、渔业;电力、热力、燃气及水生产和供应业;交通运输、仓储和邮政业;科学研究和技术服务业;教育;综合;卫生和社会工作;'
                                 ...
                                 '地产业;信息传输、软件和信息技术服务业;批发和零售业;制造业',  # 非金融行业
                        'seDate': date,
                        'sortName': '',
                        'sortType': '',
                        'isHLtitle': 'true'
...
if __name__ == '__main__':
    dir_process = multiprocessing.Process(target=getinfor())
    dir_process.start()
